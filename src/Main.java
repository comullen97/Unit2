...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("We are in the middle of creating the cupcake menu. We currently have 3 cupcakes on the menu but we need to decide on pricing");
        ...
        System.out.println("We are deciding on the price for the bottled soda. Here is the description: ");
        soda.type();
